...
for i in range(0, 100000000):
  ...
  print(line2[hour//10]+"\t"+line2[hour%10]+"\t 0\t"+line2[minute//10]+"\t"+line2[minute%10]+"\t 0\t"+line2[second//10]+"\t"+line2[second%10])
  ...
  print(line6[hour//10]+"\t"+line6[hour%10]+"\t  \t"+line6[minute//10]+"\t"+line6[minute%10]+"\t  \t"+line6[second//10]+"\t"+line6[second%10])
